...
docs/waveforms/. Sources: DESIGN_ITERATIONS.md, POWER_METHODOLOGY.md, RESULTS.md,
ARCHITECTURE_LOCKED.md, the RTL itself.

### Afternoon - diagrams and review (~3 h)

- Block diagram and FSM diagram, per docs/BLOCK_DIAGRAM_NOTES.md. Three corrections, six
